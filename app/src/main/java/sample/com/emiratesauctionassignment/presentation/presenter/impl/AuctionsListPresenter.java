...
import sample.com.emiratesauctionassignment.domain.interactor.impl.AuctionListInteractor;
...
public class AuctionsListPresenter implements MainPresenter, ResponseCallback.MYCallback {
    PresenterCallBack presenterCallBack;
    ResponseCallback responseCallback;

    public AuctionsListPresenter(Retrofit retrofit, PresenterCallBack presenterCallBack) {
        this.presenterCallBack = presenterCallBack;
        this.responseCallback = new AuctionListInteractor(retrofit, this, presenterCallBack);
    }
