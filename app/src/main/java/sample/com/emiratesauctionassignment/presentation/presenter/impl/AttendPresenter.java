...
import sample.com.emiratesauctionassignment.domain.interactor.impl.AttendInteractor;
...
public class AttendPresenter implements MainPresenter, ResponseCallback.MYCallback {
    PresenterCallBack presenterCallBack;
    ResponseCallback responseCallback;

    public AttendPresenter(Retrofit retrofit, String userId, AttendParam attendParam, String lang, PresenterCallBack presenterCallBack) {
        this.presenterCallBack = presenterCallBack;
        this.responseCallback = new AttendInteractor(retrofit,userId, attendParam, lang, this, presenterCallBack);
    }
