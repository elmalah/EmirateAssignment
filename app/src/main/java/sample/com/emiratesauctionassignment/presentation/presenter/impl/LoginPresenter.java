...
import sample.com.emiratesauctionassignment.domain.interactor.impl.LoginInteractor;
...
public class LoginPresenter implements MainPresenter, ResponseCallback.MYCallback {
    PresenterCallBack presenterCallBack;
    ResponseCallback responseCallback;

    public LoginPresenter(Retrofit retrofit, LoginParam login, String lang, PresenterCallBack presenterCallBack) {
        this.presenterCallBack = presenterCallBack;
        this.responseCallback = new LoginInteractor(retrofit, login, lang, this, presenterCallBack);
    }
